...
const GEO_MARKERS = [
  'обл', 'край', 'р-н', 'район', 'Москв', 'Санкт', 'Петербург',
  'Сибир', 'Урал', 'Крым', 'Татарстан', 'Ростов', 'Калинин',
  'Тульск', 'Тверск', 'Нижегород', 'Новосибирск', 'Омск', 'Пермск',
  'Красноярск', 'Екатеринбург', 'Челябинск', 'Ленинград', 'Калужск',
  'Краснодар', 'Воронеж', 'Белгород', 'Смоленск', 'Ставропол',
  'Псков', 'Ярославск', 'Хабаровск', 'Приморск', 'Иркутск',
  'Томск', 'Сахалин', 'Курск', 'Владимир', 'Беларусь', 'Уфа', 'Минск',
]
