...
useSeoMeta({
  description: 'Территория Хвойных — крупнейший каталог хвойных растений России. 2300+ сортов елей, сосен, пихт, туй и можжевельников с фото из частных садов и питомников.',
  ogTitle: 'Территория Хвойных — каталог хвойных растений',
  ogDescription: '2300+ сортов хвойных с фото из частных садов по всей России',
  ogType: 'website',
})
</script>
