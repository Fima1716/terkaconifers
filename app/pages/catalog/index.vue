...
useSeoMeta({
  description: 'Каталог из 2300+ сортов хвойных растений с фото. Ели, сосны, пихты, туи, можжевельники из частных садов по всей России. Фильтры по роду, виду, цвету, региону.',
})
</script>
